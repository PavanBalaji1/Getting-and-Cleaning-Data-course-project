...
TrainSetX<-read.table("file:///C:/Users/pawan/Documents/UCI HAR Dataset/train/X_train.txt")

TrainSetY<-read.table("file:///C:/Users/pawan/Documents/UCI HAR Dataset/train/Y_train.txt")

TrainSub<-read.table("file:///C:/Users/pawan/Documents/UCI HAR Dataset/train/subject_train.txt")

#Reading the data from test set

TestSetX<-read.table("file:///C:/Users/pawan/Documents/UCI HAR Dataset/test/X_test.txt")

TestSetY<-read.table("file:///C:/Users/pawan/Documents/UCI HAR Dataset/test/Y_test.txt")

TestSub<-read.table("file:///C:/Users/pawan/Documents/UCI HAR Dataset/test/subject_test.txt")

#reading activity and features

activity<-read.table("file:///C:/Users/pawan/Documents/UCI HAR Dataset/activity_labels.txt")
features<-read.table("file:///C:/Users/pawan/Documents/UCI HAR Dataset/features.txt")
